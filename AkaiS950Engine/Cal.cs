...
namespace AkaiS950Engine
{
    ...
    public static class Cal
    {
        ...
        ///
        /// STILL PROVISIONAL, AND THE ONLY THING LEFT THAT IS. This section is the loudest
        /// in the run - the one place two keygroups both sound at nearly full level, so the
        /// tones sum to the highest crest anywhere - and it is the only section still
        /// hitting the recording's ceiling. The rest of run 15 re-recorded clean; these five
        /// clips are 14.5% pinned.
        ///
        ...
        ///
        /// A pair at full level sums to +3.0, so the trend says identical ranges are
        /// probably NOT attenuated at all - the machine finds no lower and no upper
        /// keygroup, nothing to fade, and simply layers them. That would remove the special
        /// case entirely.
        ///
        /// Not shipped on that: it is a trend across two spoilt takes, not a measurement.
        /// -3.7 is what was read and it stays until a quieter take says otherwise. It is
        /// wrong in the safe direction for the 17 library pairs it applies to - too quiet by
        /// a few decibels rather than too loud.
        /// </summary>
