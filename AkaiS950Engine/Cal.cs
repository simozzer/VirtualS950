...
namespace AkaiS950Engine
{
    ...
    public static class Cal
    {
        ...
        ///
        /// The envelope time curve is badly wrong for this one stage. Two takes, converting
        /// when the sweep passed a fixed probe into a release:
        ///
        ...
        ///
        /// Run 2 covers stored 70 to 99, over which the curve climbs fifteenfold, and
        /// measures the same second throughout. Whatever the release does, it does not
        /// follow the curve, and 13 seconds is not a thing this machine does.
        ///
        /// A cap is as much as the data carries. The two takes differ by 2.5x at stored 70,
        /// and that gap is a warning in itself: turning a probe crossing into a release
        /// assumes the fall is a straight line in octaves, so two sweeps of different depths
        /// disagreeing says it is not straight. Until something measures the SHAPE, a number
        /// fitted to these crossings would be precision that is not there.
        /// </summary>
        public const double VcfReleaseMax = 1.0;
