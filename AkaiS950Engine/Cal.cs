...
namespace AkaiS950Engine
{
    ...
    public static class Cal
    {
        ...
        /// against each and the attenuations multiply. Run 15 measured a three-deep stack -
        /// keygroups at 100-112, 104-116 and 108-120 - and that is what fits:
        ///
        ///     key 110    T1      T2      T3
        ...
        ///
        /// Neither is exact and the product runs about 2 dB deep through the middle, but the
        /// ends decide it. At key 112 the product puts the bottom keygroup near -39 and the
        /// deepest-single rule puts it at -22; it measured -33, below the -30 where a tone
        /// that is not sounding at all reads in these takes. A reading at the floor is
        /// consistent with -39 and rules out -22.
        ///
        /// So: the product, exact where two keygroups overlap - the ordinary case, and the
        /// only one the library's pianos use - and about 2 dB slack where three do.
        /// </summary>
